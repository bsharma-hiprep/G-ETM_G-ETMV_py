"""
This module runs the G-ETM method as described in:
...
OutStruct is a dictionary whose fields contain the results of the Granger
fitting process.
...
def run_granger_g_etm(spike_trains, global_regressor_in, history_regressor, history_regressor_n_bins):
    ...
    for target_neuron_ind in range(n_neurons):
        ...
        # Causal connectivity matrix without FDR correction
